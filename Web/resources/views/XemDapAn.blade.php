        ...
        <div class="container dau-tien" style="padding-top: 20px ">
            <div class="row">
                <div class="col-lg-12 col-xl-8">
                    <div class="card" style="border: 0 solid transparent!important; margin-bottom: 20px">
                        ...
                        <div class="row" style="margin-bottom: 10px">
                            ...
                            <p style="margin-top: 10px; color: #00B568; font-family: 'Mali', cursive; font-weight: 600; font-size: 20px; margin-left: 35px; margin-bottom: 0!important">Giải:</p>

                            <span id="giai" style="color: black; font-family: 'Mali', cursive; font-size: 20px; margin-left: 35px"></span>
                ...
                <div class="col-lg-12 col-xl-4" style="display: flex; flex-direction: column;">
                    <button id="btnThiLai" class="btn btn-click" style="background-color: #005DA5; color: white; font-family: 'Mali', cursive; font-size: 24px; margin-bottom: 20px">THI LẠI</button>
                        ...
                        <div class="container-fluid" style="margin-top: 20px">
                            <div class="row" >
                                <div class="col" style="padding-right: 0px!important; padding-left: 10px">
                                    <button name="sentence" class="btn" style="border: 1px solid transparent!important; border-radius: 50%; background-color: transparent; font-family: 'Mali', cursive; font-size: 18px; color: white; width: 40px; height: 40px; padding-right: 0px!important; padding-left: 0px!important">01</button>
                                </div>
                                <div class="col" style="padding-right: 0px!important; padding-left: 10px">
